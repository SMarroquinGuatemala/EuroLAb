...
namespace EuroLab
{
    public partial class FrmCliente : Form
    {
        ...
        int? clienteID;
        public FrmCliente(int? clienteIDFromForm)
        {
            
            InitializeComponent();
            clienteID = clienteIDFromForm;
        }
        ...
        private void LoadDataByID()
        {
            ...
            dataTable = cliente.GetAllByID((int)clienteID);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cliente = new Cliente();
                cliente.Save(txtNombre.Text, txtApellidos.Text, txtNit.Text, txtTelefono.Text, txtDireccion.Text, Convert.ToInt32(cboDepartamento.EditValue), Convert.ToInt32(cboMunicipio.EditValue), clienteID);
